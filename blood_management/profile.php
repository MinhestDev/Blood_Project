...
<head>
	<title>Thông tin hiến máu</title>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Trang cá nhân người hiến máu</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="appointment py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Trang cá nhân người hiến máu</h3>
				<span>
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">Chi tiết trang cá nhân</h5>
...
{               ?>
						...
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">Email <span style="color:red; font-size:10px;">(Không thể thay đổi)</span></label>
