          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Quản lý & </span>hiến máu nhân đạo
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>Hệ thống hiến máu và nhận máu nhân đạo.</p>
          </div>
          <div class="col-md-4 w3l-footer my-md-0 my-4">
            <h3 class="mb-sm-3 mb-2 text-white">Địa chỉ</h3>
...
{ ?>
          ...
          <div class="col-md-4 w3l-footer">
            <h3 class="mb-sm-3 mb-2 text-white">Links</h3>
            <div class="nav-w3-l">
              <ul class="list-unstyled">
                <li>
