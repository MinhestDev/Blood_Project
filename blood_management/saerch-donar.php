	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Danh sách người hiến máu</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Địa chỉ </div>
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Danh sách người hiến máu</h3>
				<span>
...
{ ?>
					...
					<div class="price-bottom p-4">
						...
						<p class="card-text"><b>Số điện thoại: </b> <?php echo htmlentities($result->MobileNumber);?></p>
						<p class="card-text"><b>Email: </b> <?php echo htmlentities($result->EmailId);?></p>
						<p class="card-text"><b>Tuổi :</b> <?php echo htmlentities($result->Age);?></p>
						<p class="card-text"><b>Địa chỉ: </b> <?php echo htmlentities($result->Address);?></p>
						<p class="card-text"><b>Tin nhắn :</b> <?php echo htmlentities($result->Message);?></p>
						<a class="w3ls-button-agile"  href="contact-blood.php?cid=<?php echo $result->id;?>">Yêu cầu</a>
					</div>
				</div> <?php }}
else
{
echo htmlentities("Không tìm thấy bản ghi");
