...
<head>
	...
	<title>Hệ thống hiến máu | Đăng nhập Admin</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Hệ thống hiến máu | Đăng nhập Admin</h1>
...
<a href="forgot-password.php" >Quên mật khẩu</a>
								...
								<div class="card-footer text-center" style="padding-top: 30px;">
                                        <div class="small"><a href="../index.php" class="btn btn-primary">Trở về trang chủ</a></div>
                                    </div>
							</div>
						</div>
					</div>
