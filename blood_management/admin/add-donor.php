...
if($lastInsertId)
{
$msg="Thông tin của bạn đã gửi thành công";
}
else 
{
...
<head>
	...
	<title>Hệ thống hiến máu | Thêm người hiến máu</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Thêm người hiến máu</h2>
...
<label class="col-sm-2 control-label">Tuổi<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Nhóm máu<span style="color:red">*</span></label>
<div class="col-sm-4">
