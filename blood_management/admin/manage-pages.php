...
<head>
	...
	<title>Hệ thống hiến máu | Quản lý trang</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=donor">Tại sao nên trở thành người hiến máu</option>
                </select>
												</div>
											</div>
			...
			?>
									...
									<div class="form-group">
												<label class="col-sm-4 control-label">Trang chi tiết </label>
												<div class="col-sm-8">
